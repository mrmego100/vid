...
async def generate():
    print("🚀 بدء العمل على سيرفرات GitHub...")
    ...
    # 2. تحميل الفيديو (بدقة 720p كحد أقصى للسرعة)
    ydl_opts = {
    ...
    # 3. الرندر الفائق (Ultrafast) باستخدام CPU السيرفر
    print("🎬 جاري الرندر النهائي...")
    final_cmd = (
